            ...
            <div className="space-y-3 p-6">
              ...
              {order.items?.map((item, i) => (
                <div key={i} className="flex gap-3">
                  ...
                  <p className="text-sm font-bold text-luxe-black dark:text-luxe-white">
              ...
              <button
                ...
                className={`${order.status === 'pending_sync'? 'hidden' : ''} mt-4 w-full btn-gold text-sm`}
              >
                Track Order
              </button>
            </div>
    ...
    return (
      <div className="min-h-screen bg-luxe-white dark:bg-luxe-black px-4 py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mb-4 text-5xl font-heading font-black tracking-tight text-luxe-black dark:text-luxe-white">No Orders Yet</h1>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          <div className="mb-8 text-center">
            <span className="badge-gold mb-3 inline-block">Orders</span>
